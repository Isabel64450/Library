 ...
 */
final class Version20260310080741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD description VARCHAR(240) DEFAULT NULL, ADD image VARCHAR(180) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP description, DROP image');
